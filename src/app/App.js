...
const App = new Reef('#root', {
    ...
    ${keyboardEventListener()}
        ...
        <button
            onClick="myLib.create({tag: 'button', inner: '<img src=${'https://avatars1.githubusercontent.com/u/63253189?s=400&u=44cbb26bdf951e137f6e9c7076719d0088d989de&v=4'}><p>any html code</p>', only: true})"
            class="btn btn-warning"
        >
            ibtn_hello_1_only_true
        </button>
        <button
            onClick="myLib.create({tag: 'button', inner: '<img src=${'https://avatars1.githubusercontent.com/u/63253189?s=400&u=44cbb26bdf951e137f6e9c7076719d0088d989de&v=4'}><p>any html code</p>', only: false})"
